    ...
    <main className="px-[6vw] pb-20 pt-10 text-ink">
      <section className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        ...
        <div className="grid gap-4">
          ...
          <p className="text-[1.05rem] leading-relaxed text-ink-soft">
            {isInvalid
              ? "This invoice is marked invalid. Do not pay."
              : "Send the exact amount shown below to pay this invoice."}
          </p>
          <p className="text-[1.05rem] leading-relaxed text-ink-soft">
          ...
          <details className="rounded-xl border border-stroke bg-white/60 px-4 py-3 text-sm text-ink-soft shadow-soft">
            ...
            <div className="mt-3 grid gap-2">
              ...
              <p className="font-mono text-xs text-ink">
                Current block height: {systemStatus?.daemon_height?.toLocaleString() ?? "Unavailable"}
              </p>
              <p>
                This status page is public. Anyone with the link can view the current
                invoice state.
              </p>
            </div>
          </details>
